...
//     description:
//       'Cryptoverse: Busy bitcoin births new breed of crypto  Reuters',
...
//     title:
//       'Bitcoin gets vote of confidence as a long-term store of value as Tether says it will buy more of the crypto to back its stablecoin',
//     description:
...
//     urlToImage:
//       'https://i.insider.com/646507e00d92400018e6d690?width=1200&format=jpeg',
...
//     description:
//       'The world of cryptocurrencies goes beyond Bitcoin (BTC), with a plethora of alternatives offering unique features, use cases, and potential for growth. If you’re looking to diversify your crypto portfolio or explore beyond Bitcoin, this article provides an in…',
...
//     content:
//       'The world of cryptocurrencies goes beyond Bitcoin (BTC), with a plethora of alternatives offering unique features, use cases, and potential for growth. If you’re looking to diversify your crypto port… [+7977 chars]',
//   },
//   {
//     source: {
//       id: 'business-insider',
...
//     urlToImage:
//       'https://i.insider.com/6470ff66085acb0018feb4fa?width=1200&format=jpeg',
//     publishedAt: '2023-05-28T12:30:07Z',
//     content:
//       "One exec told Insider that bitcoin can't hit a record high until US inflation is under control.Yuichiro Chino/Getty Images\r\n<ul>\n<li>Bitcoin has jumped over 60% year-to-date, paring losses from a bru… [+4067 chars]",
//   },
//   {
//     source: {
//       id: 'business-insider',
...
//     description:
//       '"I think bitcoin\'s found the bottom. I think the leverage is out of it," MicroStrategy cofounder Michael Saylor said.',
...
//     description:
//       'Totalplay añadió el Bitcoin como una forma de pago para sus paquetes de cable, telefonía e internet. Grupo Salinas firmó un acuerdo con IBEX Mercado, un proveedor de servicios de pago de Bitcoin Lightning, el cual beneficiará a más cuatro millones de mexicano…',
//     url: 'http://hipertextual.com/2023/05/totalplay-bitcoin-forma-de-pago',
//     urlToImage:
//       'https://i0.wp.com/imgs.hipertextual.com/wp-content/uploads/2023/05/bitcoin-pago-totalplay.jpg?fit=2000%2C1250&quality=50&strip=all&ssl=1',
//     publishedAt: '2023-05-19T19:20:00Z',
//     content:
//       'Totalplay añadió el Bitcoin como una forma de pago para sus paquetes de cable, telefonía e internet. Grupo Salinas firmó un acuerdo con IBEX Mercado, un proveedor de servicios de pago de Bitcoin Ligh… [+2591 chars]',
//   },
//   {
//     source: {
//       id: 'business-insider',
...
//     urlToImage:
//       'https://media.wired.com/photos/6470f77482d37ced55dff512/191:100/w_1280,c_limit/Security-News-This-Week--Netflix%E2%80%99s-Password-Sharing-Crackdown-Has-Hit-the-US-Security-GettyImages-1262044708.jpg',
//     publishedAt: '2023-05-27T13:00:00Z',
//     content:
//       'Officials in Spain want to ban end-to-end encryption in the European Union, according to a leaked government document obtained by WIRED. The stance emerged as part of a survey of EU member states rel… [+3440 chars]',
//   },
//   {
//     source: {
//       id: 'wired',
...
//     urlToImage:
//       'https://media.wired.com/photos/646e9bd40124a91cee27d937/191:100/w_1280,c_limit/Wa_5.jpg',
//     publishedAt: '2023-05-25T10:00:00Z',
//     content:
//       'In the early 20th century, the psychoanalyst Carl Jung came up with the concept of the shadowthe human personalitys darker, repressed side, which can burst out in unexpected ways. Surprisingly, this … [+3734 chars]',
//   },
//   {
//     source: {
//       id: null,
...
//     description:
//       'Other than Terra, FTX is perhaps the biggest synonym for failure in the crypto industry. It’s a three-letter word dragged so far through the mud that it’s hard to distinguish it from a cow patty. Yet enough people working at the exchange think people would be…',
//     url: 'https://gizmodo.com/ftx-sam-bankman-fried-crypto-1850467212',
//     urlToImage:
//       'https://i.kinja-img.com/gawker-media/image/upload/c_fill,f_auto,fl_progressive,g_center,h_675,pg_1,q_80,w_1200/000a22167a4653aa27d08be49a865b56.jpg',
//     publishedAt: '2023-05-23T21:16:31Z',
//     content:
//       'Other than Terra, FTX is perhaps the biggest synonym for failure in the crypto industry. Its a three-letter word dragged so far through the mud that its hard to distinguish it from a cow patty. Yet e… [+2955 chars]',
//   },
//   {
//     source: {
//       id: 'business-insider',
...
//     author: 'Jennifer Sor',
//     title:
//       'US stocks trade mixed as markets await debt ceiling talks between Biden and lawmakers',
//     description:
//       'President Biden will resume debt ceiling talks with House Speaker Kevin McCarthy and other congressional leaders at 5:30pm ET on Monday.',
...
//     urlToImage:
//       'https://i.insider.com/646910d563c86a0018cd07ba?width=1200&format=jpeg',
//     publishedAt: '2023-05-20T19:16:47Z',
//     content:
//       'Crypto, and especially hidden crypto investments, have become an increasing conflict in divorces.Wenjin Chen/Getty Images\r\n<ul>\n<li>Cryptocurrency is complicating an increasing amount of divorces, a … [+2418 chars]',
//   },
//   {
//     source: {
//       id: 'abc-news',
...
//     description:
//       'The crackdown on cryptocurrency escalated today after lawmakers called for consumer trading to be regulated like gambling. In a new report by a cross-party committee, British politicians claimed the likes of Bitcoin and Ether have “no intrinsic value” and ser…',
//     url: 'https://thenextweb.com/news/crypto-no-intrinsic-value-or-useful-social-purposeshould-be-regulated-as-gambling',
//     urlToImage:
//       'https://img-cdn.tnwcdn.com/image/tnw-blurple?filter_last=1&fit=1280%2C640&url=https%3A%2F%2Fcdn0.tnwcdn.com%2Fwp-content%2Fblogs.dir%2F1%2Ffiles%2F2023%2F05%2FUntitled-design-2-9.jpg&signature=05fb070e8cfc3fcc454a08f2ff270436',
//     publishedAt: '2023-05-17T10:58:36Z',
//     content:
//       'The crackdown on cryptocurrency escalated today after lawmakers called for consumer trading to be regulated like gambling.\r\nIn a new report by a cross-party committee, British politicians claimed the… [+3380 chars]',
//   },
//   {
//     source: {
//       id: null,
...
//     description:
//       '"The Bulls are back in the driver\'s seat on the heels of investor optimism over a likely debt ceiling resolution," said one investment executive.',
...
//     author: 'Enrique Pérez',
//     title:
//       'Ledger era la gran referencia para guardar Bitcoin. Ha decepcionado a todos con un cambio repentino',
//     description:
//       'Ledger ha perdido la confianza de los usuarios. La empresa dedicada a monederos fríos ha decidido lanzar una actualización que directamente va en contra de su filosofía original. Un cambio de estrategia que ha generado muchísimas críticas y muestra lo difícil…',
...
//     content:
//       'Ledger ha perdido la confianza de los usuarios. La empresa dedicada a monederos fríos ha decidido lanzar una actualización que directamente va en contra de su filosofía original. Un cambio de estrate… [+2446 chars]',
//   },
//   {
//     source: {
//       id: null,
...
//     urlToImage:
//       'https://heise.cloudimg.io/bound/1200x1200/q85.png-lossy-85.webp-lossy-85.foil1/_www-heise-de_/imgs/18/4/1/8/9/6/4/4/shutterstock_709061209-930a4263b1a2f4ce.jpg',
//     publishedAt: '2023-05-16T15:52:00Z',
//     content:
//       'Wer in der EU virtuelle Münzen wie Bitcoin, Ethereum oder Ripple verwendet, soll künftig unabhängig vom Transaktionswert grundsätzlich identifiziert werden können. Ein solches Aus für anonyme Zahlung… [+4341 chars]',
//   },
//   {
//     source: {
//       id: 'business-insider',
...
//     description:
//       'The EU Parliament agreed last week on the world’s first comprehensive set of rules to regulate the transfer of cryptocurrencies like Bitcoin, as it looks to crack down on money laundering and illegal transfers in the bloc. From 2024, all crypto transfers, reg…',
//     url: 'https://thenextweb.com/news/crypto-payments-can-now-be-traced-like-bank-transfers-under-new-eu-law',
//     urlToImage:
//       'https://img-cdn.tnwcdn.com/image/tnw-blurple?filter_last=1&fit=1280%2C640&url=https%3A%2F%2Fcdn0.tnwcdn.com%2Fwp-content%2Fblogs.dir%2F1%2Ffiles%2F2023%2F05%2Fkanchanara-fsSGgTBoX9Y-unsplash-1.jpg&signature=318f95df47d846d6c1a3051a8aee800b',
//     publishedAt: '2023-05-22T12:30:34Z',
//     content:
//       'The EU Parliament agreed last week on the worlds first comprehensive set of rules to regulate the transfer of cryptocurrencies like Bitcoin, as it looks to crack down on money laundering and illegal … [+4249 chars]',
//   },
//   {
//     source: {
//       id: null,
...
//     description:
//       'Elliot and Dan teamed up for the podcast this week, bringing you the week’s sweetest hacks. And news too, as the ESA performed a little percussive maintenance on a Jupiter-bound space probe, …',
...
//     content:
//       'Elliot and Dan teamed up for the podcast this week, bringing you the week’s sweetest hacks. And news too, as the ESA performed a little percussive maintenance on a Jupiter-bound space probe, and we l… [+934 chars]',
//   },
//   {
//     source: {
//       id: null,
...
//     description:
//       "Insider's Phil Rosen breaks down the latest in financial news, including why small-cap stocks have fallen out of favor in recent months.",
//     url: 'https://www.businessinsider.com/stocks-investors-small-cap-markets-finance-investing-newsletter-debt-ceiling-2023-5',
//     urlToImage:
//       'https://i.insider.com/64651cba0d92400018e6db6a?width=1200&format=jpeg',
...
//     description:
//       'Investors are still waiting for lawmakers to hash out a deal to avoid a US default. Meanwhile, the Nasdaq has notched a 2023 high.',
//     url: 'https://markets.businessinsider.com/news/stocks/stock-market-news-today-dow-debt-ceiling-talks-apple-nasdaq-2023-5',
//     urlToImage:
//       'https://i.insider.com/646cb529a739dc0018090061?width=1200&format=jpeg',
...
//     description:
//       'House Speaker Kevin McCarthy said Tuesday that it\'s "possible to get a deal by the end of the week."',
...
//     urlToImage:
//       'https://i.insider.com/64554a65bcb4870018c7f794?width=1200&format=jpeg',
...
//     description:
//       'Lawmakers are still scrambling to avoid a national default, and JPMorgan warned Monday that stocks could see a violent re-pricing similar to 2011.',
...
//     description:
//       'Tejay Fletcher’s site offered tools allowing criminals to make phone calls that appeared to be from trusted companiesThe mastermind behind an online fraud shop used to con victims out of more than £100m has been jailed for more than 13 years.Tejay Fletcher, 3…',
//     url: 'https://www.theguardian.com/uk-news/2023/may/19/fraudster-tejay-fletcher-jailed-for-multimillion-pound-website-ispoof',
//     urlToImage:
//       'https://i.guim.co.uk/img/media/7050c4ec5e94a66fb6d7473bcbc764e62ec1594c/0_109_394_236/master/394.jpg?width=1200&height=630&quality=85&auto=format&fit=crop&overlay-align=bottom%2Cleft&overlay-width=100p&overlay-base64=L2ltZy9zdGF0aWMvb3ZlcmxheXMvdGctZGVmYXVsdC5wbmc&enable=upscale&s=cac06573e3443b63c32b9533145d4bb2',
...
//     description:
//       'Human rights group’s 107-page report details human cost of President Nayib Bukele’s controversial ‘war on gangs’The human cost of El Salvador’s controversial “war on gangs” has been laid bare in a new report which claims dozens of prisoners were tortured and …',
//     url: 'https://www.theguardian.com/world/2023/may/29/el-salvador-security-gangs-crackdown-cristosal-report-bukele',
//     urlToImage:
//       'https://i.guim.co.uk/img/media/1831463d0f154aa64f0e03fedac3aeb8404d642b/0_418_6487_3894/master/6487.jpg?width=1200&height=630&quality=85&auto=format&fit=crop&overlay-align=bottom%2Cleft&overlay-width=100p&overlay-base64=L2ltZy9zdGF0aWMvb3ZlcmxheXMvdGctZGVmYXVsdC5wbmc&enable=upscale&s=9fb1fc109862518771543b70e9270913',
//     publishedAt: '2023-05-29T19:17:02Z',
//     content:
//       'The human cost of El Salvadors controversial war on gangs has been laid bare in a new report which claims dozens of prisoners were tortured and killed in jail after being caught up in the year-long s… [+3537 chars]',
//   },
//   {
//     source: {
//       id: null,
...
//     urlToImage:
//       'https://heise.cloudimg.io/bound/1200x1200/q85.png-lossy-85.webp-lossy-85.foil1/_www-heise-de_/imgs/18/4/1/9/0/4/7/3/shutterstock_2155067343-cbab8f25fc8775f2.jpg',
//     publishedAt: '2023-05-18T10:29:00Z',
//     content:
//       'Der britische Finanzausschuss hat die Regierung aufgefordert, den Handel mit Kryptowährung zu regulieren. Der Finanzausschuss begründet seine Forderung damit, dass digitale Währungen wie Bitcoin und … [+2147 chars]',
//   },
//   {
//     source: {
//       id: 'engadget',
...
//     description:
//       "Seemingly overnight, Sam Bankman-Fried, the founder of FTX, went from cryptocurrency wunderkind to wanted for questioning by the FBI. After years of unfettered success, the walls of SBF's blockchain empire came crumbling down around him as his tricky financia…",
//     url: 'https://www.engadget.com/hitting-the-books-sbf-brady-dale-wiley-ftx-143033761.html',
//     urlToImage:
//       'https://s.yimg.com/uu/api/res/1.2/4w1s9qSQRiYCwgQ0HYPkIA--~B/Zmk9ZmlsbDtoPTYzMDtweW9mZj0wO3c9MTIwMDthcHBpZD15dGFjaHlvbg--/https://media-mbst-pub-ue1.s3.amazonaws.com/creatr-uploaded-images/2023-05/18b95d70-eb6c-11ed-a7fd-09985728dc43.cf.jpg',
//     publishedAt: '2023-05-14T14:30:33Z',
//     content:
//       "Seemingly overnight, Sam Bankman-Fried, the founder of FTX, went from cryptocurrency wunderkind to wanted for questioning by the FBI. After years of unfettered success, the walls of SBF's blockchain … [+12543 chars]",
//   },
//   {
//     source: {
//       id: null,
...
//     description:
//       'Condensando un montón de información en algo parecido a la esfera de un reloj, Timechain Calendar muestra datos en tiempo real sobre la cadena de bloques de bitcoin. Pero además de eso también permite revisar todo lo que sucedió en el pasado –desde el 3 de en…',
...
//     description:
//       'Senate Republican Leader Mitch McConnell said he doesn\'t have a "secret plan" to prevent a US debt default, which could happen in early June.',
...
//     author: 'Carla Mozée',
//     title:
//       'US stocks trade mixed as investors assess progress on debt ceiling talks',
//     description:
...
//     content:
//       'An American flag hangs behind traders working on the floor of the New York Stock Exchange.Drew Angerer/Getty Images\r\n<ul>\n<li>US stocks were mixed on Monday as traders digested the latest debt ceilin… [+3215 chars]',
//   },
//   {
//     source: {
//       id: 'business-insider',
...
//     description:
//       'Treasury Secretary Janet Yellen reiterated to Congress that the US government could run out of money to pay its bills by as early as June 1.',
//     url: 'https://markets.businessinsider.com/news/stocks/stock-market-news-fed-minutes-split-more-interest-rate-hikes-2023-5',
//     urlToImage:
//       'https://i.insider.com/5f6899d2323fc4001e0d7626?width=1200&format=jpeg',
...
//     description:
//       'More banking fears have surfaced, with shares of PacWest plunging on reports that it is weighing strategic options, including a sale.',
//     url: 'https://markets.businessinsider.com/news/stocks/stock-market-news-today-fed-rates-economy-bank-crisis-pacwest-2023-5',
//     urlToImage:
//       'https://i.insider.com/6453adf0dcb78700180cd6a2?width=1200&format=jpeg',
...
//     description:
//       'The S&P 500 notched its first win after four losses, powering past a jump in bond yields sparked by the stronger-than-expected jobs report for April.',
//     url: 'https://markets.businessinsider.com/news/stocks/stock-market-news-dow-apple-nasdaq-jobs-report-regional-banks-2023-5',
//     urlToImage:
//       'https://i.insider.com/62fcb73bf1df7e0018ead5e8?width=1200&format=jpeg',
...
//     description:
//       'Since China banned crypto mining in 2021, a number of operations have moved to Texas, requiring an abundance of energy that is costing residents.',
//     url: 'https://www.businessinsider.com/crypto-bitcoin-mining-texas-rising-energy-bill-cost-per-customer-2023-4',
//     urlToImage:
//       'https://i.insider.com/644be03374e9330018ef8ab5?width=1200&format=jpeg',
//     publishedAt: '2023-05-02T14:48:09Z',
//     content:
//       'The influx of crypto mining facilities in Texas has raised annual power bills across the statePhoto by Mark Felix / AFP) (Photo by MARK FELIX/AFP /AFP via Getty Images\r\n<ul>\n<li>Texas has become home… [+3511 chars]',
//   },
//   {
//     source: {
//       id: 'business-insider',
...
//     description:
//       'Trading in the month of May kicked off with the second largest US bank failure on record as traders prepped for a crucial Fed decision on Wednesday.',
//     url: 'https://markets.businessinsider.com/news/stocks/stock-market-news-dow-first-republic-bank-failure-seizure-fed-2023-5',
//     urlToImage:
//       'https://i.insider.com/641311ec5f4f54001919ddad?width=1200&format=jpeg',
...
//     description:
//       'Major US indexes ended lower on Friday, with the S&P 500 notching its second-straight losing week. US default fears grew this week amid stalled talks.',
//     url: 'https://markets.businessinsider.com/news/stocks/stock-market-news-today-us-debt-ceiling-default-recession-fears-2023-5',
//     urlToImage:
//       'https://i.insider.com/5e970175b3b092567c2cf358?width=1200&format=jpeg',
...
//     urlToImage:
//       'https://i.insider.com/634992172f7a5a00185286f9?width=1200&format=jpeg',
...
//     description:
//       'The Dow snapped a losing streak as investors headed into Memorial Day anticipating Washington will reach a deal to raise the debt ceiling.',
...
//     description:
//       'Stocks may notch gains ahead of the Memorial Day holiday as lawmakers appear to be nearing a deal to lift the $31 trillion debt ceiling.',
//     url: 'https://markets.businessinsider.com/news/stocks/stock-market-news-dow-debt-ceiling-talks-deal-nasdaq-sp500-2023-5',
//     urlToImage:
//       'https://i.insider.com/64709f933be3b50019f6f3de?width=1200&format=jpeg',
//     publishedAt: '2023-05-26T13:37:50Z',
//     content:
//       'Traders work the floor of the New York Stock Exchange in New York City.TIMOTHY A. CLARY/AFP via Getty Images\r\n<ul>\n<li>US stocks rose Friday following reports lawmakers are nearing a deal to raise th… [+3197 chars]',
//   },
//   {
//     source: {
//       id: 'business-insider',
...
//     author: 'Jennifer Sor',
//     title:
//       "'Rich Dad Poor Dad' author Robert Kiyosaki warns inflation is systemic and investors should buy gold, real estate, gas, and food",
//     description:
...
//     description:
//       'JPMorgan shares stood out as a gainer in the Dow on a losing day for US stocks after First Republic Bank collapsed.',
...
//     urlToImage:
//       'https://i.insider.com/64500c5574e9330018efc500?width=1200&format=jpeg',
...
//     urlToImage:
//       'https://i.insider.com/6463811c3c46f3001898e0e3?width=1200&format=jpeg',
//     publishedAt: '2023-05-16T13:40:31Z',
//     content:
//       "U.S. President Joe Biden and Speaker of the House Kevin McCarthy (R-CA) depart the U.S. Capitol following the Friends of Ireland Luncheon on Saint Patrick's Day March 17, 2023 in Washington, DC. The … [+2917 chars]",
//   },
//   {
//     source: {
//       id: 'business-insider',
...
//     title:
//       "Jack Dorsey encouraged the student who tracks Elon Musk's jet to keep posting on Bluesky after his Twitter ban",
//     description:
//       "Jack Sweeney joined Jack Dorsey's latest social media venture Bluesky in April and set up his tracking account @ElonJet.",
//     url: 'https://www.businessinsider.com/jack-dorsey-encourages-the-student-who-tracks-elon-musk-jet-2023-5',
//     urlToImage:
//       'https://i.insider.com/645765a16a3ee80019092586?width=1200&format=jpeg',
//     publishedAt: '2023-05-07T09:55:34Z',
//     content:
//       "Jack Dorsey encouraged the college student who tracks Elon Musk's private jet to keep on posting.Jack Sweneey, Joe Raedle, Clive Mason/Getty Images\r\n<ul>\n<li>Jack Dorsey encouraged the college studen… [+3531 chars]",
//   },
//   {
//     source: {
//       id: 'business-insider',
...
//     author: 'Carla Mozée',
//     title:
//       'US stocks edge higher as investors await updates on debt ceiling negotiations',
//     description:
//       'The S&P 500 finished higher after two sessions in the red and after weekly back-to-back losses. Traders were waiting for debt ceiling talks to resume.',
//     url: 'https://markets.businessinsider.com/news/stocks/stock-market-news-dow-nasdaq-debt-ceiling-talks-banks-sp500-2023-5',
//     urlToImage:
//       'https://i.insider.com/5e8b238892e8ba33b0350f73?width=1200&format=jpeg',
...
//     description:
//       'Investors were anxious Tuesday with no word on a debt-ceiling deal. "It\'s a slow walk," Rep. Patrick McHenry said, according to Roll Call.',
//     url: 'https://markets.businessinsider.com/news/stocks/stock-market-news-today-nasdaq-dow-debt-ceiling-talks-sp500-2023-5',
//     urlToImage:
//       'https://i.insider.com/6113ca37ad63f30019501f8b?width=1200&format=jpeg',
...
//     description:
//       "Nvidia's huge quarterly earnings report led the Nasdaq higher, as investors pile into one of the clear leaders in the early days of the AI gold rush.",
...
//     urlToImage:
//       'https://i.insider.com/63ab3e2147bbe40019837632?width=1200&format=jpeg',
...
//     author: null,
//     title:
//       'Tether says it will invest up to 15% of its profits in bitcoin, as the company shifts its reserves towards crypto and away from US government debt (Yogita Khatri/The Block)',
//     description:
//       'Yogita Khatri / The Block:\nTether says it will invest up to 15% of its profits in bitcoin, as the company shifts its reserves towards crypto and away from US government debt  —  - Tether is set to purchase bitcoin on a regular basis from its profits.  — It he…',
//     url: 'https://www.techmeme.com/230517/p23',
//     urlToImage:
//       'https://www.tbstat.com/wp/uploads/2020/09/20200914_Tether-1200x675.jpg',
//     publishedAt: '2023-05-17T16:45:01Z',
//     content:
...
//     title: 'Aufruf an Spender: Warum die Hamas keine Bitcoins mehr will',
//     description:
//       'Kryptowährungen wie Bitcoin versprechen Anonymität. Daran glauben inzwischen auch Terrororganisationen nicht mehr.',
//     url: 'https://www.faz.net/aktuell/finanzen/aufruf-an-spender-warum-die-hamas-keine-bitcoins-mehr-will-18872081.html',
//     urlToImage:
//       'https://media0.faz.net/ppmedia/aktuell/1760109441/1.8872554/facebook_teaser/die-kassam-brigaden-sind-der.jpg',
//     publishedAt: '2023-05-13T12:19:50Z',
//     content:
//       'Fans von Kryptowährungen wie Bitcoin schätzen an ihnen vor allem das Versprechen von Anonymität und die Unabhängigkeit von Banken und staatlichen Institutionen. Kritiker sehen sie gerade deshalb scho… [+1408 chars]',
//   },
//   {
//     source: {
//       id: null,
...
//     },
//     author: 'Tyler Lee',
//     title: 'Mining Bitcoin in the US might soon no longer be worth it',
//     description:
//       'The US government has recently proposed a massive tax on cryptocurrency miners, potentially making the activity less worth it.',
//     url: 'https://phandroid.com/2023/05/03/mining-bitcoin-in-the-us-might-soon-no-longer-be-worth-it/',
//     urlToImage: null,
//     publishedAt: '2023-05-03T10:00:53Z',
//     content:
//       'There is a reason why mining for cryptocurrency is so popular. This is because of the value of cryptocurrencies such as Bitcoin where a single Bitcoin is worth close to $30,000 (at this time of posti… [+1229 chars]',
//   },
// ];
...
export const sampleData = [
  ...
  {
    title: 'Breaking News 21',
    description: 'This is breaking news 1',
    source: 'News Source 1',
  },
  {
    title: 'Breaking News 22',
    description: 'This is breaking news 2',
    source: 'News Source 2',
  },
  {
    title: 'Breaking News 23',
    description: 'This is breaking news 3',
    source: 'News Source 3',
  },
  {
    title: 'Breaking News 24',
    description: 'This is breaking news 4',
    source: 'News Source 4',
  },
  {
    title: 'Breaking News 25',
    description: 'This is breaking news 5',
    source: 'News Source 5',
  },
  {
    title: 'Breaking News 26',
    description: 'This is breaking news 6',
    source: 'News Source 6',
  },
  {
    title: 'Breaking News 27',
    description: 'This is breaking news 7',
    source: 'News Source 7',
  },
  {
    title: 'Breaking News 28',
    description: 'This is breaking news 8',
    source: 'News Source 8',
  },
  {
    title: 'Breaking News 29',
    description: 'This is breaking news 9',
    source: 'News Source 9',
  },
  {
    title: 'Breaking News 30',
    description: 'This is breaking news 10',
    source: 'News Source 10',
  },
  {
    title: 'Breaking News 31',
    description: 'This is breaking news 1',
    source: 'News Source 1',
  },
  {
    title: 'Breaking News 32',
    description: 'This is breaking news 2',
    source: 'News Source 2',
  },
  {
    title: 'Breaking News 33',
    description: 'This is breaking news 3',
    source: 'News Source 3',
  },
  {
    title: 'Breaking News 34',
    description: 'This is breaking news 4',
    source: 'News Source 4',
  },
  {
    title: 'Breaking News 35',
    description: 'This is breaking news 5',
    source: 'News Source 5',
  },
  {
    title: 'Breaking News 36',
    description: 'This is breaking news 6',
    source: 'News Source 6',
  },
  {
    title: 'Breaking News 37',
    description: 'This is breaking news 7',
    source: 'News Source 7',
  },
  {
    title: 'Breaking News 38',
    description: 'This is breaking news 8',
    source: 'News Source 8',
  },
  {
    title: 'Breaking News 39',
    description: 'This is breaking news 9',
    source: 'News Source 9',
  },
  {
